	...
	return (
		<div>
			...
			<div className="container w-auto scroll-content my-16">
				...
				<p>Wij gebruiken cookies en soortgelijke volgtechnologie&euml;n om de activiteit op onze Dienst te volgen en we bewaren bepaalde informatie.</p>
				<p>Cookies zijn bestanden met een kleine hoeveelheid gegevens die een anonieme unieke ID kunnen bevatten. Cookies worden van een website verzonden naar uw browser en opgeslagen op uw apparaat. Er worden ook andere volgtechnologie&euml;n gebruikt zoals beacons, tags en scripts om gegevens te verzamelen en te volgen en om onze Dienst te verbeteren en te analyseren.</p>
				...
				<p>Johan Hoste zal alle redelijkerwijs noodzakelijke stappen ondernemen om ervoor te zorgen dat uw gegevens veilig en in overeenstemming met dit Privacybeleid worden behandeld en dat uw Persoonsgegevens nooit worden overgedragen aan een organisatie of een land als er geen gepaste controles zijn ingesteld, inclusief de veiligheid van uw gegevens en andere persoonsgegevens.</p>
				<h2>Openbaarmaking van gegevens</h2>
				<h3>Wettelijke vereisten</h3>
				<p>Johan Hoste kan uw Persoonsgegevens openbaar maken als het te goeder trouw de mening is toegedaan dat een dergelijke handeling noodzakelijk is:</p>
				<ul>
				...
				<ul>
					<li>
						...
						<p>U kunt aangeven dat u uw activiteit op de Dienst niet beschikbaar wenst te maken voor Google Analytics door de Google Analytics opt-out browser add-on te installeren. Deze add-on zorgt ervoor dat het Google Analytics JavaScript (ga.js, analytics.js en dc.js) geen informatie kan delen met Google Analytics over uw activiteiten op het internet.</p>
						<p>Voor meer informatie over de privacypraktijken van Google verwijzen wij u naar de internetpagina van Google Privacy en voorwaarden:&nbsp;<a href="https://policies.google.com/privacy?hl=en">https://policies.google.com/privacy?hl=en</a></p>
					</li>
				</ul>
				<h2>Links naar andere sites</h2>
				<p>Onze Dienst kan links bevatten naar andere sites die niet door ons worden beheerd. Als u klikt op een link van een externe partij wordt u naar de site van die externe partij gebracht. Wij raden u sterk aan het Privacybeleid te verifi&euml;ren van elke site die u bezoekt.</p>
